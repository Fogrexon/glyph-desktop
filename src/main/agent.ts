...
- 設定（プロバイダ・モデル・API キー・MCP）は左レールの設定タブを開く。パレットは閉じる
- ショートカット（キー割り当て）は同じ設定タブのショートカット欄を開く。パレットは閉じる
...
export const WORKSPACE_TOOLS: LlmTool[] = [
  ...
  },
  {
    name: 'open_settings',
    description:
      '左レールの設定タブ（一般）を開く。プロバイダ・モデル・API キー・MCP。パレットは閉じる。キー割り当てには open_shortcuts。',
    parameters: { type: 'object', properties: {} }
  },
  {
    name: 'open_shortcuts',
    description:
      '左レールの設定タブでショートカット（キー割り当て）一覧を開く。キー設定を見せて／変えて、と言われたとき。パレットは閉じる。',
    parameters: { type: 'object', properties: {} }
  },
  {
